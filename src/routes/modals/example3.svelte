...
<div class="block p-8 space-y-4 md:flex md:space-y-0 md:space-x-4">
	...
	<ModalButton id={extraLargeModalId} btnName={btnExLName} btnColor={btnExLColor} />
</div>
...
>
	<p class="text-base leading-relaxed text-{textSColor}-500 dark:text-{textSColor}-400">
...
>
	<p class="text-base leading-relaxed text-{textMColor}-500 dark:text-{textMColor}-400">
		Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut
		labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco.
	</p>
</MediumModal>
...
>
	<p class="text-base leading-relaxed text-{textLColor}-500 dark:text-{textLColor}-400">
		Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut
		labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco.
	</p>
</LargeModal>
...
>
	<p class="text-base leading-relaxed text-{textExLColor}-500 dark:text-{textExLColor}-400">
		Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut
		labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco.
	</p>
</ExtraLargeModal>
